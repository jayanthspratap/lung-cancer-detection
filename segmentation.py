...
def execute():
    ...
    conversion_factor = 314 # conversion factor for px to cm for area, found based on PET scan dimensions
    contour_areas = [round(cv2.contourArea(i)/conversion_factor, 3) for i in contours]
